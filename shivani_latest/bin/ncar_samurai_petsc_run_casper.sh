...
#mpiexec_mpt -n 1  omplace $HERE/../build/release/bin/samurai $* -tao_monitor -tao_gttol 1e-4 -tao_bnk_ksp_rtol 1e-4 -tao_bnk_ksp_monitor
...
mpirun -n 1 -x OMP_NUM_THREADS=36 $HERE/../build/release/bin/samurai $* -tao_monitor -tao_gttol 1e-4 -tao_bnk_ksp_rtol 1e-4 -tao_bnk_ksp_monitor
#srun -n 1 $HERE/../build/release/bin/samurai $* -tao_monitor -tao_gttol 1e-4 -tao_bnk_ksp_rtol 1e-4 -tao_bnk_ksp_monitor
